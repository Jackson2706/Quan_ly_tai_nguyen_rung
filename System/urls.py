...
urlpatterns = (
    [
        ...
        #     path(
        #         "add_class_save", HodViews.add_course_save, name="add_course_save"
        #     ),
        ...
        #     path(
        #         "manage_school_year",
        #         HodViews.manage_school_year,
        #         name="manage_school_year",
        #     ),
        #     path(
        #         "add_session_save",
        ...
        #     ),
        #     path(
        #         "add_school_year_save",
        #         HodViews.add_school_year_save,
        #         name="add_school_year_save",
        #     ),
        #     path(
        #         "check_email_exist",
        ...
        #     ),
        #     path(
        #         "staff_feedback", StaffViews.staff_feedback, name="staff_feedback"
        #     ),
        #     path(
        #         "staff_feedback_save",
        ...
        #     ),
        #     path(
        #         "save_student_edit_result",
        #         StaffViews.save_student_edit_result,
        #         name="save_student_edit_result",
        #     ),
        #     path(
        #         "edit_student_result",
        #         StaffViews.staff_edit_result,
